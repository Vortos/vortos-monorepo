...
final class Version20260505114121 extends AbstractMigration
{
    ...
    PRIMARY KEY (role, permission)
        ...
        $this->addSql('CREATE INDEX idx_role_permissions_role ON role_permissions (role)');
        $this->addSql('CREATE INDEX idx_role_permissions_permission ON role_permissions (permission)');
    ...
    PRIMARY KEY (user_id, role)
        ...
        $this->addSql('CREATE INDEX idx_user_roles_role ON user_roles (role)');
    }
