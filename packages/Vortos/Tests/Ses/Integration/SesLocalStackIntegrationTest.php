...
namespace Vortos\Tests\Ses\Integration;
...
final class SesLocalStackIntegrationTest extends TestCase
{
    ...
    private const SUPPRESSION_TABLE = 'ses_suppression_list';
    private const OUTBOX_TABLE      = 'ses_outbox';
    ...
    public function test_send_with_attachment(): void
    {
        ...
        $email = Email::new()
            ...
            ->attach(\Vortos\Ses\ValueObject\Attachment::fromContent(
