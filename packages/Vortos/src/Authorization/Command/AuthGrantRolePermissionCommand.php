...
#[AsCommand(name: 'vortos:auth:role-permission:grant', description: 'Grant a registered permission to a runtime role')]
final class AuthGrantRolePermissionCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $this->admin->grant($actor, $role, $permission, $reason, array_merge($metadata, ['source' => 'console']));
