...
#[AsCommand(name: 'vortos:auth:user-role:remove', description: 'Remove a runtime role from a user')]
final class AuthRemoveUserRoleCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $this->admin->remove($actor, $user, $role, $this->nullableOption($input, 'reason'), array_merge($metadata, ['source' => 'console']));
