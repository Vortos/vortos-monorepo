...
/**
 * A target that declares no `target_arch` constraint — used to exercise the
 * "arch gate provably N/A → Skip" path in TargetArchCheck.
 */
#[AsDriver('no-arch')]
final class NoArchConstraintTarget implements DeployTargetInterface
{
    ...
    {
        return new TargetStatus(ActiveColor::None, '', 'unknown', new \DateTimeImmutable());
    }
}
