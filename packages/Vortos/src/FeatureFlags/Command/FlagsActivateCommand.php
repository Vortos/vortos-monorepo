...
#[AsCommand(name: 'vortos:flags:activate', description: 'Transition a flag to Active lifecycle state')]
final class FlagsActivateCommand extends Command
{
    ...
    protected function configure(): void
    {
        $this
            ...
            ->addOption('reason',  null, InputOption::VALUE_REQUIRED, 'Reason for activation')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $this->writeService->changeLifecycle($name, FlagLifecycleState::Active, 'cli', $input->getOption('reason'));
        $output->writeln(sprintf('  <info>activated:</info> %s', $name));
