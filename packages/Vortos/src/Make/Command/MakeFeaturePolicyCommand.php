...
#[AsCommand(
    name: 'vortos:make:feature-policy',
    description: 'Generate a feature access policy',
)]
final class MakeFeaturePolicyCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln("<info>vortos:make:feature-policy</info> {$name} --context={$context}");
        $output->writeln('');

        $this->engine->write(
            "{$context}/Application/Policy/{$name}FeaturePolicy.php",
            $this->engine->render('feature-policy', $vars),
            $output,
        );
