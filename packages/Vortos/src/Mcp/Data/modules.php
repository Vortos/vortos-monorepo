...
return [
    ...
    'backup' => [
        ...
        'commands' => [
            ...
            'backup:doctor'      => 'Fail-closed backup preflight: engine resolvable (--engine/VORTOS_BACKUP_ENGINE), its client binaries (pg_dump/pg_restore/pg_basebackup, version >= server major) on PATH, and the store resolves. Run in the backup sidecar before wiring the schedule. Flags: --engine, --json. Same toolchain probe gates deploy:doctor (backup.toolchain).',
