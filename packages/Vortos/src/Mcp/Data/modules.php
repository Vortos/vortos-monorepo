...
return [
    ...
    'deploy' => [
        ...
        'commands' => [
            'deploy'              => 'Deploy an environment through the fail-closed preflight loop. Always registered; FAILS LOUD if release/migration absent. Flags: --env, --dry-run (rehearse, zero mutation), --image-digest, --resume, --actor, --json',
