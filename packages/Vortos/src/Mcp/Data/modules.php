...
return [
    ...
    'deploy' => [
        ...
        'config'   => [
            'config/deploy.php'                => 'return static fn (DeploymentDefinitionBuilder $b) => $b->host(\'ssh-compose\')->registry(\'ghcr\')->strategy(\'blue-green\')->forEnvironment(\'production\', fn ($b) => $b->autoRollback(true));',
