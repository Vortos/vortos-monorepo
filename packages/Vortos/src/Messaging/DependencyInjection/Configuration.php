                ...
                ->arrayNode('outbox')
                    ...
                    ->children()
                        ->scalarNode('table')
                            ...
                            ->info('Outbox table name. Must match the table created by vortos:migrate:publish.')
                        ->end()
                ...
                ->arrayNode('dlq')
                    ...
                    ->children()
                        ->scalarNode('table')
                            ...
                            ->info('Consumer DLQ table name. Must match the table created by vortos:migrate:publish.')
                        ->end()
                    ->end()
                ->end()
