 ...
 * The hook receives the EventEnvelope and the array $headers by reference — mutating
 * $headers inside the hook affects what gets written to the outbox.
 * Use this for injecting custom headers, adding tenant IDs, or enriching the message before external delivery.
 */
