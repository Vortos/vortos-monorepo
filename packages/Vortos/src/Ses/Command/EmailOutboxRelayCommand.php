 ...
 *
 * Polls the ses_outbox table for pending rows and delivers them via the
 * configured mailer. Runs until interrupted (SIGTERM / Ctrl+C) or until
 * --once is passed for one-shot usage.
 *
 * Usage:
 *   bin/console ses:outbox:relay
 *   bin/console ses:outbox:relay --once
 *   bin/console ses:outbox:relay --sleep=2
 */
#[AsCommand(
    name:        'ses:outbox:relay',
