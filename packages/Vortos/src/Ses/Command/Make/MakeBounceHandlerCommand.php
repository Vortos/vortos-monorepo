 ...
 *
 * Usage:
 *   bin/console ses:make:bounce-handler NotifySupport --context=Notification
 */
#[AsCommand(
    name:        'ses:make:bounce-handler',
...
final class MakeBounceHandlerCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln("<info>ses:make:bounce-handler</info> {$name} --context={$context}");
        $output->writeln('');
