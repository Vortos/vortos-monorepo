 ...
 *
 * Usage:
 *   bin/console ses:make:complaint-handler UnsubscribeUser --context=Notification
 */
#[AsCommand(
    name:        'ses:make:complaint-handler',
...
final class MakeComplaintHandlerCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln("<info>ses:make:complaint-handler</info> {$name} --context={$context}");
        $output->writeln('');
