...
namespace Vortos\Ses\Command\Make;
 ...
 *
 * Usage:
 *   bin/console ses:make:email-middleware LogRecipients --context=Notification
 *   bin/console ses:make:email-middleware RateLimit --context=Billing --priority=550
 */
#[AsCommand(
    name:        'ses:make:email-middleware',
...
final class MakeSesEmailMiddlewareCommand extends Command
{
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $output->writeln("<info>ses:make:email-middleware</info> {$name} --context={$context}");
        $output->writeln('');
