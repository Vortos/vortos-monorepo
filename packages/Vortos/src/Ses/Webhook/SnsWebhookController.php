 ...
 * The route path is configured via vortos_ses.webhooks.route_path (default: /webhooks/aws/ses).
 */
#[AsController]
final class SnsWebhookController
{
    ...
    #[Route('/webhooks/aws/ses', name: 'vortos_ses.sns_webhook', methods: ['POST'])]
